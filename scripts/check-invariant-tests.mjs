...
// title contains `[invariant:<slug>]` (FR-003; ADR-007).
//
...
/** Collects { slug, at } from every x-invariants of the document. */
...
process.exit(report(problems, `Invariants: ${slugs.length} declared, ${withTest} with a test`));
