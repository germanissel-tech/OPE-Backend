...
export const PROBLEM_TYPES = {
  ...
  "invalid-ingest-keys": { status: 500, title: "A merchant needs one or two non-empty ingest keys" },
  "invalid-origins": { status: 500, title: "A merchant needs at least one registered origin" },
  "invalid-platform-keys": { status: 500, title: "A merchant has more than two platform keys" },
  "invalid-platform-secrets": { status: 500, title: "A merchant has more than two platform signing secrets" },
  "multiple-active-experiments": { status: 500, title: "A merchant has more than one active experiment" },
  "duplicate-experiment-id": { status: 500, title: "Two experiments of a merchant share an identifier" },
  // Border of the HTTP adapter: the body limit of the consumer, judged before the body is read.
  "payload-too-large": { status: 413, title: "The request body exceeds the limit of its consumer" },
