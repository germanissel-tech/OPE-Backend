...
/** What a list of ports resolves to, in order: the parameters of a builder that declares them. */
export type Values<D extends readonly AnyPort[]> = { [K in keyof D]: Served<D[K]> };
