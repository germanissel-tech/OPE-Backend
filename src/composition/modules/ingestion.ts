// ingestion module: the event batch. It needs the kernel, the decision ledger and its own
// dedup; it owns (binds) only the dedup, which shares the profile's clock.
