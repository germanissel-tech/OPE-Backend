...
única implementación era en memoria. La persistencia real (feature "Persistence and resilience" del mapa) va a poner una base de datos
...
- La feature de persistencia implementa el buffer, los lotes, la cola muerta y el circuit breaker detrás de estos
