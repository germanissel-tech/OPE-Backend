...
| `auditoria/` | Criterios de diseño de la auditoría de arquitectura y los informes y handoffs fechados de cada auditoría integral.                                                                      | fuente            | la skill de auditoría (criterios), el dueño (informes)                   | `check:markers`; la skill de auditoría (feature 019)                           |
