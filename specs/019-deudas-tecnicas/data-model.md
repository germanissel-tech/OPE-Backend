...
| `Plugin`              | `plugins/auditable-architecture/{.claude-plugin/plugin.json, README.md, skills/…}`                           | `version` semver; no importa nada del repo por ruta (prueba por inspección de imports); marketplace en `.claude-plugin/marketplace.json` |
