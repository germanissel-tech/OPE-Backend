...
- [ ] T013 [P] [US1] `docs/adr/010-decisiones-abiertas-del-mvp.md`: "cada una se cierra en `01 §13` de los documentos del MVP"; párrafo con las decisiones de producto confirmadas citando el ADR nuevo de T012; estado sigue `abierta` (R-02)
